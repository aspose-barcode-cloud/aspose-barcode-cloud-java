...
//     /**
//      * Recognize barcode from an url or from request body. Request body can contain raw data
// bytes
...
//         PostGenerateMultipleRequest request = new
// PostGenerateMultipleRequest(generatorParamsList);
//         request.format = "jpg";
