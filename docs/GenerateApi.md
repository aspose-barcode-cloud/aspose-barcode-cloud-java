...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            File result = api.generate(barcodeType, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GenerateApi.generate");
            e.printStackTrace();
        }
    }
}
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            File result = api.generateBody(generateParams);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GenerateApi.generateBody");
            e.printStackTrace();
        }
    }
}
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String data = "data_example"; // String | String represents data to encode
        try {
            File result = api.generateMultipart(barcodeType, data);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GenerateApi.generateMultipart");
            e.printStackTrace();
        }
    }
}
